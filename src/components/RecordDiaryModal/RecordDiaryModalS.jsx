...
const imgPeriod = isRetina ? snackImg2 : snackImg;
const typeName = "Snack";
...
const RecordDiaryModal = ({ isOpen, onClose }) => {
  ...
  const handleAddMore = (e) => {
    ...
    if (foodData[foodData.length - 1].name === "") return;  // не дозволяє додавати, якщо не введено дані
  ...
  //   // console.log();
  //   if (fieldName === "" || targ.value === "-" || targ.value === "+") {
  //     return console.log("Incorrect data provided");
  //   }
      
  //   if(targ.value <0 ) {targ.value = Math.abs(targ.value)}
...
//     4.POST /api/user/food-intake
// C фронтенда {type:'breakfast', products:[{name:'english breakfast', carbonohidrates:22, protein:22, fat:22, calories:59},
// {name:'tea', carbonohidrates:22, protein:22, fat:22, calories:59}]}
    try {
